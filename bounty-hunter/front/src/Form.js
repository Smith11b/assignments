...
export default class Form extends Component {
    ...
    submitHandler(e){
        ...
        axios.post('http://localhost:3500/bounties', newBounty)
        ...
        return (
            <div className = "form">
                <form action="submit">
                    ...
                    <input name = "fname"  value = {this.state.fname} onChange = {this.fnameOnChange}></input>
                    <label for = "lname">Last Name:</label>
                    <input name = "lname" value = {this.state.lname} onChange = {this.lnameOnChange}></input>
                    <label for = "bountyAmount">Bounty Amount:</label>
                    <input name = "bountyAmount" type = "number" value = {this.state.bountyAmount} onChange = {this.bountyAmountOnChange}/>
